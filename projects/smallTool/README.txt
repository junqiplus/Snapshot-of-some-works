...
4. Input a keyword like "int" in the inputbox on the top of the main board, then click on the button on top middle of main board.
5. A window will appear with statistics on it.